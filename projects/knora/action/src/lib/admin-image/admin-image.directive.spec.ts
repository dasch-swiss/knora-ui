...
import { AdminImageComponent } from 'src/app/knora-ui-examples/action-demo/admin-image/admin-image.component';
...
@Component({
    template: `<img kuiAdminImage [image]="img" [type]="type"/>`
})
class TestAdminImageComponent {

    img: string = 'http://dasch.swiss/content/images/2017/11/DaSCH_Logo_RGB.png';
    type: string = 'project';
