...
import { KnoraConstants, Property } from '@knora/core';
...
export class Equals implements ComparisonOperator {
  ...
  type = SearchConstants.EqualsComparisonOperator;
  label = SearchConstants.EqualsComparisonLabel;
...
export class NotEquals implements ComparisonOperator {
  ...
  type = SearchConstants.NotEqualsComparisonOperator;
  label = SearchConstants.NotEqualsComparisonLabel;
...
export class GreaterThanEquals implements ComparisonOperator {
  ...
  type = SearchConstants.GreaterThanEqualsComparisonOperator;
  label = SearchConstants.GreaterThanEqualsComparisonLabel;
...
export class GreaterThan implements ComparisonOperator {
  ...
  type = SearchConstants.GreaterThanComparisonOperator;
  label = SearchConstants.GreaterThanComparisonLabel;
...
export class LessThan implements ComparisonOperator {
  ...
  type = SearchConstants.LessThanComparisonOperator;
  label = SearchConstants.LessThanComparisonLabel;
...
export class LessThanEquals implements ComparisonOperator {
  ...
  type = SearchConstants.LessThanEqualsComparisonOperator;
  label = SearchConstants.LessThanQualsComparisonLabel;
...
export class Exists implements ComparisonOperator {
  ...
  type = SearchConstants.ExistsComparisonOperator;
  label = SearchConstants.ExistsComparisonLabel;
...
export class Like implements ComparisonOperator {
  ...
  type = SearchConstants.LikeComparisonOperator;
  label = SearchConstants.LikeComparisonLabel;
...
export class Match implements ComparisonOperator {
  ...
  type = SearchConstants.MatchComparisonOperator;
  label = SearchConstants.MatchComparisonLabel;
