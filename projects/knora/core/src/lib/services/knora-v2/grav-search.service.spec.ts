...
describe('GravSearchService', () => {
    ...
    it('should create a KnarQL query string with restriction to a resource class using offset 0', inject([GravSearchService], (service: GravSearchService) => {
    ...
    it('should create a KnarQL query string with restriction to a resource class using offset 1', inject([GravSearchService], (service: GravSearchService) => {
    ...
    it('should create a KnarQL query string with a property matching a value using offset 0', inject([GravSearchService], (service: GravSearchService) => {
