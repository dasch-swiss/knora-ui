...
import {Observable, forkJoin, fromPromise} from 'rxjs';
...
export class OntologyCacheService {
    ...
    private getResourceClassIrisFromOntologyResponse(classDefinitions: Array<Object>): string[] {
        ...
        for (const classDef of classDefinitions) {
            ...
            if (classIri !== KnoraConstants.Resource && this.nonResourceClasses.indexOf(classIri) === -1 && (classDef[KnoraConstants.IsResourceClass] !== undefined && classDef[KnoraConstants.IsResourceClass] === true)) {
