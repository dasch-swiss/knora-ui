...
describe('ProjectsService', () => {
    ...
    describe('#getProjects', () => {
        ...
        it('should parse project-response (images)', () => {
            ...
            const result: ProjectsResponse | ProjectsResponse[] = jsonConvert.deserialize(imagesProjectResponseJson, ProjectResponse);
        ...
        it('should parse project-response (incunabula)', () => {
            ...
            const result: ProjectsResponse | ProjectsResponse[] = jsonConvert.deserialize(incunabulaProjectResponseJson, ProjectResponse);
        ...
        it('should parse project-response (anything)', () => {
            ...
            const result: ProjectsResponse | ProjectsResponse[] = jsonConvert.deserialize(anythingProjectResponseJson, ProjectResponse);
