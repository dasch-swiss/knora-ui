...
describe('ReadPropertyItem', () => {
    ...
    it('should create a ReadTextValueAsHtml', () => {
        ...
        const htmlItem = new ReadTextValueAsHtml(
            'http://rdfh.ch/00c650d23303/values/af68552c3626',
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#description',
        ...
        expect(htmlItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(htmlItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#TextValue'
        );
        expect(htmlItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#description'
        );
        expect(htmlItem.html).toEqual(
            'This is a test with <a href="http://rdfh.ch/test" class="salsah-link">a standoff link</a>'
        );
        expect(htmlItem.getClassName()).toEqual('ReadTextValueAsHtml');
        expect(htmlItem.getContent()).toEqual(
            'This is a test with <a href="http://rdfh.ch/test" class="salsah-link">a standoff link</a>'
        );

        expect(htmlItem.referredResources).toBe(referredResourcesInStandoff);
        expect(
            htmlItem.getReferredResourceInfo(
                'http://rdfh.ch/test',
                ontologyInfo
            )
        ).toEqual('test resource (book)');
    });

    it('should create a ReadTextValueAsXml', () => {
        const xmlItem = new ReadTextValueAsXml(
            'http://rdfh.ch/00c650d23303/values/af68552c3626',
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#description',
            '<root>This is a test</root>',
            'http://rdfh.ch/00c650d23303/mappings/af68552c3626'
        );

        expect(xmlItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(xmlItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#TextValue'
        );
        expect(xmlItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#description'
        );
        expect(xmlItem.xml).toEqual('<root>This is a test</root>');
        expect(xmlItem.mappingIri).toEqual(
            'http://rdfh.ch/00c650d23303/mappings/af68552c3626'
        );
    ...
    it('should create a ReadDateValue for a precise date', () => {
        ...
        expect(dateItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(dateItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#DateValue'
        );
        expect(dateItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#pubDate'
        );
    ...
    it('should create a ReadDateValue fro a period', () => {
        ...
        expect(dateItem.getContent()).toEqual(
            'GREGORIAN:(CE) 2018-5-18:(CE) 2019-6-19'
        );
    });
    ...
    it('should create a ReadLinkValue with a referred resource Iri only', () => {
        ...
        expect(linkItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(linkItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#LinkValue'
        );
        expect(linkItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasReference'
        );
        ...
        expect(linkItem.getReferredResourceInfo(ontologyInfo)).toEqual(
            'http://rdfh.ch/test'
        );
    });
    ...
    it('should create a ReadIntegerValue', () => {
        const intItem = new ReadIntegerValue(
            'http://rdfh.ch/00c650d23303/values/af68552c3626',
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasInteger',
            1
        );

        expect(intItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(intItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#IntValue'
        );
        expect(intItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasInteger'
        );
    ...
    it('should create a ReadDecimalValue', () => {
        const decItem = new ReadDecimalValue(
            'http://rdfh.ch/00c650d23303/values/af68552c3626',
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasDecimal',
            1.1
        );

        expect(decItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(decItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#DecimalValue'
        );
        expect(decItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasDecimal'
        );
    ...
    it('should create a ReadStillImageFileValue (full)', () => {
        ...
        expect(imageItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(imageItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#StillImageFileValue'
        );
        expect(imageItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasImage'
        );
        expect(imageItem.getClassName()).toEqual('ReadStillImageFileValue');
        expect(imageItem.getContent()).toEqual(
            'http://localhost:1024/knora/incunabula_0000003856.jp2/full/1904,2700/0/default.jpg'
        );

        expect(imageItem.imageFilename).toEqual('incunabula_0000003856.jp2');
        expect(imageItem.imageServerIIIFBaseURL).toEqual(
            'http://localhost:1024/knora'
        );
        expect(imageItem.imagePath).toEqual(
            'http://localhost:1024/knora/incunabula_0000003856.jp2/full/1904,2700/0/default.jpg'
        );
        ...
        expect(imageItem.makeIIIFUrl(10)).toEqual(
            'http://localhost:1024/knora/incunabula_0000003856.jp2/full/pct:10/0/default.jpg'
        );
    });
    ...
    it('should create a ReadTextFileValue', () => {
        ...
        expect(textFileItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(textFileItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#TextFileValue'
        );
        expect(textFileItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasTextFile'
        );
    ...
    it('should create a ReadColorValue', () => {
        ...
        expect(colorItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(colorItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#ColorValue'
        );
        expect(colorItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasColor'
        );
    ...
    it('should create a ReadGeomValue', () => {
        ...
        expect(geomItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(geomItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#GeomValue'
        );
        expect(geomItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasRegion'
        );
        expect(geomItem.geometryString).toEqual(
            '{"status":"active","lineColor":"#ff3333","lineWidth":2,"points":[{"x":0.08098591549295775,"y":0.16741071428571427},{"x":0.7394366197183099,"y":0.7299107142857143}],"type":"rectangle","original_index":0}'
        );
        expect(geomItem.getClassName()).toEqual('ReadGeomValue');
        expect(geomItem.getContent()).toEqual(
            '{"status":"active","lineColor":"#ff3333","lineWidth":2,"points":[{"x":0.08098591549295775,"y":0.16741071428571427},{"x":0.7394366197183099,"y":0.7299107142857143}],"type":"rectangle","original_index":0}'
        );
    ...
    it('should create a ReadUriValue', () => {
        ...
        expect(uriItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(uriItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#UriValue'
        );
        expect(uriItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasUri'
        );
    ...
    it('should create a ReadBooleanValue', () => {
        ...
        expect(boolItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(boolItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#BooleanValue'
        );
        expect(boolItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasBoolean'
        );
    ...
    it('should create a ReadIntervalValue', () => {
        ...
        expect(intervalItem.id).toEqual(
            'http://rdfh.ch/00c650d23303/values/af68552c3626'
        );
        expect(intervalItem.type).toEqual(
            'http://api.knora.org/ontology/knora-api/v2#IntervalValue'
        );
        expect(intervalItem.propIri).toEqual(
            'http://0.0.0.0:3333/ontology/0803/incunabula/v2#hasInterval'
        );
