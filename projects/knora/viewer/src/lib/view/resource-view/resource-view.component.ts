...
import { ApiServiceError, FileRepresentation, GuiOrder, IncomingService, KnoraConstants, OntologyInformation, Resource, ResourceService, ResourcesSequence, ReadStillImageFileValue } from '@knora/core';
import { FileRepresentation } from 'projects/knora/core/src/lib/declarations/api/v2/representations/fileRepresentation';
